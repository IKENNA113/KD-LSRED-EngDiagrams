...
sys.path.insert(0, "C:/Users/ikenn/KD_YOLO/yolo-distiller")

from ultralytics import YOLO
import numpy as np

# Load the pre-trained YOLOv8l model (teacher model)
teacher_model = YOLO("C:/Users/ikenn/KD_YOLO/yolo-distiller/circuit_best.pt")

# Load the student model (YOLOv8s)
student_model = YOLO("yolov8s.pt")

# Define the path to your custom dataset .yaml file
dataset_yaml = "C:/Users/ikenn/KD_YOLO/yolo-distiller/data_circuit/dataset.yaml"  # Replace with your dataset .yaml file path

# Define hyperparameters for training
train_params = {
    "model": "yolov8s.pt",  # Pretrained model weights
    ...
    "name": "yolov8s_distil_cir_Temp6_weight4",  # Experiment name
    ...
    "teacher": teacher_model.model,  # Teacher model for knowledge distillation
    "distillation_loss": "cwd",  # Distillation loss type
}

# Train the student model with knowledge distillation
results = student_model.train(**train_params)
...
test_params = {
    ...
    "name": "yolov8s_distil_cir_Temp6_weight4_val",  # Experiment name
    "exist_ok": True,  # Overwrite existing experiment
...
# Validate the model
metrics = student_model.val(**test_params)
